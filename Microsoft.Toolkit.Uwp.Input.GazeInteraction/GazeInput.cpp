...
static DependencyProperty^ s_isInvokeAnimationEnabledProperty = DependencyProperty::RegisterAttached("InvokeAnimationEnabled", IBox<bool>::typeid, GazeInput::typeid, ref new PropertyMetadata(true));
#endif
